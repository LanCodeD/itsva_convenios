    ...
    <div className="max-w-full w-full h-auto mx-auto p-5">
      <div className="bg-white shadow-lg rounded-xl p-6 flex flex-col items-center md:flex-row md:items-start">
        ...
        <div className="md:w-1/3 flex flex-col items-center mb-8 md:mb-0">
          {perfil.foto_perfil && (
            <div className="relative rounded-full w-72 h-72 object-cover mb-4 shadow-md transition-transform transform hover:scale-105 animate-fade-in">
              <Image
        ...
        <div className="md:w-2/3 space-y-6">
          ...
          <div className="text-lg text-gray-700 space-y-6">
            <p className="text-xl text-gray-700 ">
              <strong className="font-semibold text-gray-900 text-2xl">
                Información:
              </strong>{" "}
              {perfil.informacion}
            </p>
